...
public class XsectGraph extends JDialog implements ActionListener {
	...
	private InputStream xsCloseInputStream = this.getClass().getResourceAsStream(CsdpFunctions.getIconImagePath()+"/"+"XSCloseButton.png");
	private InputStream cursorIconInputStream = this.getClass().getResourceAsStream(CsdpFunctions.getIconImagePath()+"/"+"ArrowButton.png");
	private InputStream reverseXsectIconInputStream = this.getClass().getResourceAsStream(CsdpFunctions.getIconImagePath()+"/"+"ReverseXsectButton.png");
	private InputStream movePointIconInputStream = this.getClass().getResourceAsStream(CsdpFunctions.getIconImagePath()+"/"+"MoveXsectPointButton.png");
	//	private InputStream addPointIcon = this.getClass().getResourceAsStream(CsdpFunctions.getIconImagePath()+"/"+"AddXsectPointButton.png");
	private InputStream addLeftPointIconInputStream = this.getClass().getResourceAsStream(CsdpFunctions.getIconImagePath()+"/"+"AddBeginningXsectPointButton.png");
	private InputStream addRightPointIconInputStream = this.getClass().getResourceAsStream(CsdpFunctions.getIconImagePath()+"/"+"AddEndingXsectPointButton.png");
	private InputStream insertPointIconInputStream = this.getClass().getResourceAsStream(CsdpFunctions.getIconImagePath()+"/"+"InsertXsectPointButton.png");
	private InputStream deletePointIconInputStream = this.getClass().getResourceAsStream(CsdpFunctions.getIconImagePath()+"/"+"DeleteXsectPointButton.png");
	private InputStream cursorIconSelectedInputStream = this.getClass().getResourceAsStream(CsdpFunctions.getIconImagePath()+"/"+"ArrowButtonSelected.png");
	private InputStream movePointIconSelectedInputStream = this.getClass().getResourceAsStream(CsdpFunctions.getIconImagePath()+"/"+"MoveXsectPointButtonSelected.png");
	//	private InputStream addPointIconSelectedInputStream = this.getClass().getResourceAsStream(CsdpFunctions.getIconImagePath()+"/"+"AddXsectPointButtonSelected.png");
	private InputStream addBeginningPointIconSelectedInputStream = this.getClass().getResourceAsStream(CsdpFunctions.getIconImagePath()+"/"+"AddBeginningXsectPointButtonSelected.png");
	private InputStream addEndingPointIconSelectedInputStream = this.getClass().getResourceAsStream(CsdpFunctions.getIconImagePath()+"/"+"AddEndingXsectPointButtonSelected.png");
	private InputStream insertPointIconSelectedInputStream = this.getClass().getResourceAsStream(CsdpFunctions.getIconImagePath()+"/"+"InsertXsectPointButtonSelected.png");
	private InputStream deletePointIconSelectedInputStream = this.getClass().getResourceAsStream(CsdpFunctions.getIconImagePath()+"/"+"DeleteXsectPointButtonSelected.png");
	private InputStream keepIconInputStream = this.getClass().getResourceAsStream(CsdpFunctions.getIconImagePath()+"/"+"KeepButton.png");
	private InputStream restoreIconInputStream = this.getClass().getResourceAsStream(CsdpFunctions.getIconImagePath()+"/"+"RestoreButton.png");
	private InputStream colorByDistanceIconInputStream = this.getClass().getResourceAsStream(CsdpFunctions.getIconImagePath()+"/"+"ColorDistanceButton.png");
	private InputStream colorByDistanceIconSelectedInputStream = this.getClass().getResourceAsStream(CsdpFunctions.getIconImagePath()+"/"+"ColorDistanceButtonSelected.png");
	private InputStream colorBySourceIconInputStream = this.getClass().getResourceAsStream(CsdpFunctions.getIconImagePath()+"/"+"ColorSourceButton.png");
	private InputStream colorBySourceIconSelectedInputStream = this.getClass().getResourceAsStream(CsdpFunctions.getIconImagePath()+"/"+"ColorSourceButtonSelected.png");
	private InputStream colorByYearIconInputStream = this.getClass().getResourceAsStream(CsdpFunctions.getIconImagePath()+"/"+"ColorYearButton.png");
	private InputStream colorByYearIconSelectedInputStream = this.getClass().getResourceAsStream(CsdpFunctions.getIconImagePath()+"/"+"ColorYearButtonSelected.png");
	private InputStream autoXSIconInputStream = this.getClass().getResourceAsStream(CsdpFunctions.getIconImagePath()+"/"+"AutoXSButton.png");
	
	private ImageIcon _xsCloseIcon = CsdpFunctions.createScaledImageIcon(xsCloseInputStream, WIDE_ICON_WIDTH, WIDE_ICON_HEIGHT);
	private ImageIcon _cursorIcon = CsdpFunctions.createScaledImageIcon(cursorIconInputStream, ICON_WIDTH, ICON_HEIGHT);
	private ImageIcon _reverseXsectIcon = CsdpFunctions.createScaledImageIcon(reverseXsectIconInputStream, ICON_WIDTH, ICON_HEIGHT);
	private ImageIcon _movePointIcon = CsdpFunctions.createScaledImageIcon(movePointIconInputStream, ICON_WIDTH, ICON_HEIGHT);
	//	private ImageIcon _addPointIcon = CsdpFunctions.createScaledImageIcon(addPointIconUrl, ICON_WIDTH, ICON_HEIGHT);
	private ImageIcon _addLeftPointIcon = CsdpFunctions.createScaledImageIcon(addLeftPointIconInputStream, ICON_WIDTH, ICON_HEIGHT);
	private ImageIcon _addRightPointIcon = CsdpFunctions.createScaledImageIcon(addRightPointIconInputStream, ICON_WIDTH, ICON_HEIGHT);
	private ImageIcon _insertPointIcon = CsdpFunctions.createScaledImageIcon(insertPointIconInputStream, ICON_WIDTH, ICON_HEIGHT);
	private ImageIcon _deletePointIcon = CsdpFunctions.createScaledImageIcon(deletePointIconInputStream, ICON_WIDTH, ICON_HEIGHT);
	private ImageIcon _cursorIconSelected = CsdpFunctions.createScaledImageIcon(cursorIconSelectedInputStream, ICON_WIDTH, ICON_HEIGHT);
	private ImageIcon _movePointIconSelected = CsdpFunctions.createScaledImageIcon(movePointIconSelectedInputStream, ICON_WIDTH, ICON_HEIGHT);
	//	private ImageIcon _addPointIconSelected = CsdpFunctions.createScaledImageIcon(addPointIconSelectedInputStream, ICON_WIDTH, ICON_HEIGHT);
	private ImageIcon _addUpstreamPointIconSelected = CsdpFunctions.createScaledImageIcon(addBeginningPointIconSelectedInputStream, ICON_WIDTH, ICON_HEIGHT);
	private ImageIcon _addDownstreamPointIconSelected = CsdpFunctions.createScaledImageIcon(addEndingPointIconSelectedInputStream, ICON_WIDTH, ICON_HEIGHT);
	private ImageIcon _insertPointIconSelected = CsdpFunctions.createScaledImageIcon(insertPointIconSelectedInputStream, ICON_WIDTH, ICON_HEIGHT);
	private ImageIcon _deletePointIconSelected = CsdpFunctions.createScaledImageIcon(deletePointIconSelectedInputStream, ICON_WIDTH, ICON_HEIGHT);

	private ImageIcon _keepIcon = CsdpFunctions.createScaledImageIcon(keepIconInputStream, WIDE_ICON_WIDTH, WIDE_ICON_HEIGHT);
	private ImageIcon _restoreIcon = CsdpFunctions.createScaledImageIcon(restoreIconInputStream, (int)(1.3*WIDE_ICON_WIDTH), WIDE_ICON_HEIGHT);

	private ImageIcon _colorByDistanceIcon = CsdpFunctions.createScaledImageIcon(colorByDistanceIconInputStream, COLOR_BY_ICON_WIDTH, COLOR_BY_ICON_HEIGHT);
	private ImageIcon _colorByDistanceIconSelected = CsdpFunctions.createScaledImageIcon(colorByDistanceIconSelectedInputStream, COLOR_BY_ICON_WIDTH, COLOR_BY_ICON_HEIGHT);
	private ImageIcon _colorBySourceIcon = CsdpFunctions.createScaledImageIcon(colorBySourceIconInputStream, COLOR_BY_ICON_WIDTH, COLOR_BY_ICON_HEIGHT);
	private ImageIcon _colorBySourceIconSelected = CsdpFunctions.createScaledImageIcon(colorBySourceIconSelectedInputStream, COLOR_BY_ICON_WIDTH, COLOR_BY_ICON_HEIGHT);
	private ImageIcon _colorByYearIcon = CsdpFunctions.createScaledImageIcon(colorByYearIconInputStream, COLOR_BY_ICON_WIDTH, COLOR_BY_ICON_HEIGHT);
	private ImageIcon _colorByYearIconSelected = CsdpFunctions.createScaledImageIcon(colorByYearIconSelectedInputStream, COLOR_BY_ICON_WIDTH, COLOR_BY_ICON_HEIGHT);
	private ImageIcon _autoXSIcon = CsdpFunctions.createScaledImageIcon(autoXSIconInputStream, WIDE_ICON_WIDTH, WIDE_ICON_HEIGHT);
	...
	public XsectGraph(CsdpFrame gui, App app, BathymetryData data, XsectBathymetryData xsectBathymetryData, 
		...
		InputStream metadataIconInputStream = this.getClass().getResourceAsStream(CsdpFunctions.getIconImagePath()+"/"+"MetadataIcon.png");
		//		ImageIcon _metadataIcon = new ImageIcon(metadataIconUrl);
		ImageIcon _metadataIcon = CsdpFunctions.createScaledImageIcon(metadataIconInputStream, WIDE_ICON_WIDTH*4, WIDE_ICON_HEIGHT);
