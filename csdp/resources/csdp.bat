...
%JDK_HOME%\bin\java -Xmx256m -Djava.library.path="o:\java\csdp\semmscon" -cp o:\java\classes;o:\java\vista\lib\vista.jar;o:\java\csdpDistribution\swing\csdp\lib\jpy.jar;o:\java\csdpDistribution\swing\csdp\lib\pd.jar DWR.CSDP.Csdp
